...
public class App 
{
    public static void main( String[] args )
    {
        ...
        System.out.println("\nEs decidido, " + player1.getName() + "jugará con el " + player1.getRol() + " y el color " + player1.getColour() + ",y " + player2.getName() + "jugará con el " + player2.getRol() + " y el color " +player2.getColour() );
